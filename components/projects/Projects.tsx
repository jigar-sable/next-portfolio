...
const Projects = ({ projectsData }: Props) => {
    ...
    return (
        <SectionWrapper id="projects" className="mx-4 md:mx-0 min-h-screen">
            ...
            <div className="w-[20.5rem] overflow-x-auto scroll-hide md:w-full max-w-screen-sm mx-auto mt-6 flex justify-between items-center gap-2 md:gap-3 bg-white dark:bg-grey-800 p-2 rounded-md">
            ...
            <div className="md:mx-6 lg:mx-auto lg:w-3/4 my-4 md:my-8 mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-10">
...
export const ViewAll = ({ handleClick, title }: { handleClick: MouseEventHandler, title: string }) => {
    return (
        <>
