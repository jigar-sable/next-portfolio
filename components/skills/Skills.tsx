...
const Skills = ({ skillData }: Props) => {
    ...
    return (
        <SectionWrapper id='skills' className="min-h-screen mt-12 md:mt-0 mx-4 md:mx-0">
            ...
            <div className="lg:w-3/5 my-8 mx-auto md:px-12 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 place-items-center gap-8">
