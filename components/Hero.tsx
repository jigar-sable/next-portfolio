...
const Hero = ({ mainData }: HeroProps) => {
    ...
    return (
        <section id='home' className={`${theme === 'light' ? "bg-heropattern bg-cover bg-bottom" : "bg-grey-900"} relative min-h-screen w-full flex flex-col-reverse lg:flex-row py-16 lg:py-48 justify-around mx-auto overflow-hidden`}>
