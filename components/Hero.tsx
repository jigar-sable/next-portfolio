...
const Hero = ({ mainData }: HeroProps) => {
    ...
    return (
        <SectionWrapper id='home' className={`${theme === 'light' ? "bg-heropattern bg-cover" : "bg-grey-900"} relative min-h-screen w-full flex flex-col lg:flex-row py-16 md:py-48 justify-around mx-auto overflow-hidden`}>

            <div className="flex flex-col gap-4 md:gap-6 text-left lg:w-1/3 mx-4 md:mx-6 lg:mx-4">
            ...
            <div className="relative mx-auto lg:mx-0 md:mt-16 lg:mt-0">
                <div className="w-60 h-60 md:w-80 md:h-80 lg:-translate-x-16">
                ...
                <div className="absolute grid top-0 -right-12 lg:-right-4 w-16 h-16 bg-white dark:bg-grey-800 rounded-full place-items-center hover:shadow-lg transition-shadow">
                    <Image alt='tech-stack' className="h-10 w-10 object-cover" src={techStackImages[1]} width={100} height={100} />
                </div>
                <div className="absolute grid bottom-[4.5rem] -right-16 lg:bottom-[8.5rem] lg:-right-12 w-14 h-14 md:w-16 md:h-16 bg-white dark:bg-grey-800 rounded-full place-items-center hover:shadow-lg transition-shadow">
                    <Image alt='tech-stack' className="h-8 w-8 md:h-10 md:w-10 object-cover" src={techStackImages[2]} width={100} height={100} />
                </div>
                <div className="absolute grid -bottom-8 -right-8 lg:-bottom-0 lg:right-6 w-16 h-16 bg-white dark:bg-grey-800 rounded-full place-items-center hover:shadow-lg transition-shadow">
